...
import { TERMS_PAGE_SEO, WEBSITE_URL, WEBSITE_NAME } from "../src/lib/constants";

const TermsAndConditions = () => {
  return (
    <>
      <SEO metaData={TERMS_PAGE_SEO} />
      <Layout>
        <Container>
          ...
          <p>
            ...
            use of {WEBSITE_NAME}'s Website, located at {WEBSITE_URL}. <br />
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use {WEBSITE_NAME} if you do not agree to
          ...
          <h2>Cookies</h2>
          <p>
            We employ the use of cookies. By accessing {WEBSITE_NAME}, you agreed to
            use cookies in agreement with the {WEBSITE_NAME}'s Privacy Policy. <br />
          ...
          <h2>License</h2>
          <p>
            Unless otherwise stated, {WEBSITE_NAME} and/or its licensors own the
            intellectual property rights for all material on {WEBSITE_NAME}. All
            intellectual property rights are reserved. You may access this from
            {WEBSITE_NAME} for your own personal use subjected to restrictions set in
          ...
          <p>
            ...
            {WEBSITE_NAME} does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of {WEBSITE_NAME},its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, {WEBSITE_NAME} shall
            ...
            {WEBSITE_NAME} reserves the right to monitor all Comments and to remove any
          ...
          <p>
            You hereby grant {WEBSITE_NAME} a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of {WEBSITE_NAME}; and
            ...
            sending an e-mail to {WEBSITE_NAME}. Please include your name, your
